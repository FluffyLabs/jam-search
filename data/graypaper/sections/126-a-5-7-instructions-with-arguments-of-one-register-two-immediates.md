...
\end{aligned}$$
  ...
  ------------ -- --------------------------------------------------------------------------------------------
  70              $\cyclic{{\memory}'}_{{\registers}_A + \nu_X} = \nu_Y \bmod 2^8$
  (lr)1-3 71      $\cyclic{{\memory}'}\subrange{{\registers}_A + \nu_X}{2} = \encode[2]{\nu_Y \bmod 2^{16}}$
  (lr)1-3 72      $\cyclic{{\memory}'}\subrange{{\registers}_A + \nu_X}{4} = \encode[4]{\nu_Y \bmod 2^{32}}$
  (lr)1-3 73      $\cyclic{{\memory}'}\subrange{{\registers}_A + \nu_X}{8} = \encode[8]{\nu_Y}$
  ------------ -- --------------------------------------------------------------------------------------------
