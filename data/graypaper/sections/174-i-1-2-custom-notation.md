...
:   The set of work-report $\mathbb{G}$uarantees. See equation [eq:guarantee].
...
:   The set representing the state of an $\mathbb{I}$nner PVM instance. See equation [eq:innerpvm].
...
:   The set of single-service accumulation $\mathbb{O}$utputs. See equation [eq:acconeout].
...
:   The set of slot-sealer $\mathbb{T}$ickets. See equation [eq:ticket].

$\operandtuple$

:   The information concerning a single work-item once prepared as an operand for the accumulation function. See equation [eq:operandtuple].

$\valcount$

:   The set of $\mathbb{V}$alidator key-set sizes. See equation [eq:valcount].
