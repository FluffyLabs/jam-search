...
The inner PVM invocation host-calls, meanwhile, depend on an integrated PVM type, which we shall denote $\pvmguest$. It holds some program code, instruction counter and RAM: $$
