---
type: page
url: 'https://github.com/FluffyLabs/typeberry/pull/358'
title: Document odd behavior of getPageNumber
site: github.com/FluffyLabs/typeberry
created_at: '2025-04-27T21:45:43.000Z'
last_modified: '2025-04-27T21:45:43.000Z'
content_kind: pr
---

# Document odd behavior of getPageNumber

## Pull Request by @tomusdrw

FYI: @mateuszsikora 

I initially though the function is incorrect, but it seems that `2**32 >>> whatever` yield `0`, hence the function does not fail for maximal `SbrkIndex` value.

It seems that this may result in a bug in `memory-builder`, where if `maxHeapSize` was set to the end of memory.
...
A comment was added to the `finalize` method in the `MemoryBuilder` class within the memory module, highlighting a known issue when `endHeapIndex` equals `MEMORY_SIZE`. Additionally, a new test case was introduced in the memory utilities test suite to verify the behavior of `getPageNumber` for the maximum sbrk index address, ensuring it returns page number 0. No changes were made to the declarations of exported or public entities.

## Changes

| File(s)                                                                                     | Change Summary                                                                                                 |
|--------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| packages/core/pvm-interpreter/memory/memory-builder.ts                                     | Added a comment in the `finalize` method noting incorrect behavior when `endHeapIndex` equals `MEMORY_SIZE`.  |
| packages/core/pvm-interpreter/memory/memory-utils.test.ts                                  | Added a test case to check that `getPageNumber` returns 0 for the max sbrk index address.                     |
...
sequenceDiagram
    ...
    TestRunner->>MemoryUtils: tryAsSbrkIndex(MEMORY_SIZE)
    MemoryUtils-->>TestRunner: address

    TestRunner->>MemoryUtils: getPageNumber(address)
    MemoryUtils-->>TestRunner: 0
```
...
<!--  -->
...
There are 3 ways to chat with [CodeRabbit](https://coderabbit.ai?utm_source=oss&utm_medium=github&utm_campaign=FluffyLabs/typeberry&utm_content=358):
...
| File | Benchmark | Ops |  |
|------|-----------|-----|--|
| [bytes/compare.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/compare.ts) | Comparing Uint32 bytes | 14272 ±0.32% | fastest ✅ |
| [bytes/compare.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/compare.ts) | Comparing raw bytes | 8409.8 ±0.32% | 41.07% slower |
| [bytes/hex-from.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/hex-from.ts) | parse hex using `Number` with NaN checking | 136577.06 ±0.09% | 86.05% slower |
| [bytes/hex-from.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/hex-from.ts) | parse hex from char codes | 978796.51 ±0.27% | fastest ✅ |
| [bytes/hex-from.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/hex-from.ts) | parse hex from string nibbles | 555967.11 ±0.34% | 43.2% slower |
| [bytes/hex-to.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/hex-to.ts) | number toString + padding | 320748.92 ±0.07% | 10.93% slower |
| [bytes/hex-to.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/bytes/hex-to.ts) | manual | 360092.26 ±0.06% | fastest ✅ |
| [codec/bigint.compare.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/bigint.compare.ts) | compare custom | 180458139.77 ±4.03% | 33.28% slower |
| [codec/bigint.compare.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/bigint.compare.ts) | compare bigint | 270475859.27 ±5.59% | fastest ✅ |
| [codec/bigint.decode.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/bigint.decode.ts) | decode custom | 244370743.15 ±5.63% | fastest ✅ |
| [codec/bigint.decode.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/bigint.decode.ts) | decode bigint | 108518084.33 ±3.18% | 55.59% slower |
| [codec/decoding.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/decoding.ts) | manual decode | 24026199.69 ±0.78% | 86.91% slower |
| [codec/decoding.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/decoding.ts) | int32array decode | 183516201.32 ±2.11% | fastest ✅ |
| [codec/decoding.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/decoding.ts) | dataview decode | 182680801.73 ±1.77% | 0.46% slower |
| [codec/encoding.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/encoding.ts) | manual encode | 3146207.49 ±0.38% | 18.54% slower |
| [codec/encoding.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/encoding.ts) | int32array encode | 3862447.45 ±0.2% | fastest ✅ |
| [codec/encoding.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/encoding.ts) | dataview encode | 3842542.47 ±0.22% | 0.52% slower |
| [codec/view_vs_collection.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get first element from Decoded | 30326.22 ±0.39% | 78.26% slower |
| [codec/view_vs_collection.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get first element from View | 139487.38 ±0.2% | fastest ✅ |
| [codec/view_vs_collection.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get 50th element from Decoded | 30413.57 ±0.06% | 78.2% slower |
| [codec/view_vs_collection.ts[3]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get 50th element from View | 60852.42 ±0.1% | 56.37% slower |
| [codec/view_vs_collection.ts[4]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get last element from Decoded | 30445.39 ±0.06% | 78.17% slower |
| [codec/view_vs_collection.ts[5]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_collection.ts) | Get last element from View | 39709.12 ±0.08% | 71.53% slower |
| [codec/view_vs_object.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get the first field from Decoded | 457381.03 ±0.61% | 5.87% slower |
| [codec/view_vs_object.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get the first field from View | 456584.78 ±0.04% | 6.03% slower |
| [codec/view_vs_object.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get the first field as view from View | 454340.9 ±0.08% | 6.49% slower |
| [codec/view_vs_object.ts[3]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get two fields from Decoded | 456238.37 ±0.58% | 6.1% slower |
| [codec/view_vs_object.ts[4]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get two fields from View | 376847.49 ±0.06% | 22.44% slower |
| [codec/view_vs_object.ts[5]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get two fields from materialized from View | 485884.68 ±0.12% | fastest ✅ |
| [codec/view_vs_object.ts[6]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get two fields as views from View | 370577.19 ±0.72% | 23.73% slower |
| [codec/view_vs_object.ts[7]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get only third field from Decoded | 460504.2 ±0.07% | 5.22% slower |
| [codec/view_vs_object.ts[8]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get only third field from View | 457303.56 ±0.07% | 5.88% slower |
| [codec/view_vs_object.ts[9]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/codec/view_vs_object.ts) | Get only third field as view from View | 455564.62 ±0.73% | 6.24% slower |
| [collections/map-set.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map-set.ts) | 2 gets + conditional set | 102856.18 ±0.13% | fastest ✅ |
| [collections/map-set.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map-set.ts) | 1 get 1 set | 62626.74 ±0.04% | 39.11% slower |
| [collections/map_vs_sorted.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map_vs_sorted.ts) | Map | 289952.13 ±0.27% | fastest ✅ |
| [collections/map_vs_sorted.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map_vs_sorted.ts) | Map-array | 104680.85 ±0.03% | 63.9% slower |
| [collections/map_vs_sorted.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map_vs_sorted.ts) | Array | 162549.97 ±0.2% | 43.94% slower |
| [collections/map_vs_sorted.ts[3]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/collections/map_vs_sorted.ts) | SortedArray | 201647.75 ±0.2% | 30.45% slower |
| [hash/blake2b.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/blake2b.ts) | hasher with simple allocator | 0.0458 ±0.75% | fastest ✅ |
| [hash/blake2b.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/blake2b.ts) | hasher with page allocator | 0.0457 ±0.36% | 0.22% slower |
| [hash/index.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with numeric representation | 193.22 ±0.65% | 26.13% slower |
| [hash/index.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with string representation | 119.49 ±0.1% | 54.32% slower |
| [hash/index.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with symbol representation | 185.56 ±0.03% | 29.06% slower |
| [hash/index.ts[3]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with uint8 representation | 165.68 ±0.05% | 36.66% slower |
| [hash/index.ts[4]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with packed representation | 261.57 ±0.47% | fastest ✅ |
| [hash/index.ts[5]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with bigint representation | 194.85 ±0.05% | 25.51% slower |
| [hash/index.ts[6]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/hash/index.ts) | hash with uint32 representation | 205.45 ±0.03% | 21.46% slower |
| [logger/index.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/logger/index.ts) | console.log with string concat | 3220328.46 ±65.94% | fastest ✅ |
| [logger/index.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/logger/index.ts) | console.log with args | 667272.19 ±110.87% | 79.28% slower |
| [math/add_one_overflow.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/add_one_overflow.ts) | add and take modulus | 190191928.14 ±36.41% | 29.4% slower |
| [math/add_one_overflow.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/add_one_overflow.ts) | condition before calculation | 269382550.58 ±6.51% | fastest ✅ |
| [math/count-bits-u32.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/count-bits-u32.ts) | standard method | 87371739.6 ±1.81% | 67.96% slower |
| [math/count-bits-u32.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/count-bits-u32.ts) | magic | 272730216.08 ±5.7% | fastest ✅ |
| [math/count-bits-u64.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/count-bits-u64.ts) | standard method | 3721424.13 ±0.26% | 58.32% slower |
| [math/count-bits-u64.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/count-bits-u64.ts) | magic | 8927598.6 ±0.3% | fastest ✅ |
| [math/mul_overflow.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/mul_overflow.ts) | multiply and bring back to u32 | 263378688.3 ±7.13% | fastest ✅ |
| [math/mul_overflow.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/mul_overflow.ts) | multiply and take modulus | 262432725.21 ±8.11% | 0.36% slower |
| [math/switch.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/switch.ts) | switch | 277996614.16 ±5.28% | fastest ✅ |
| [math/switch.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/math/switch.ts) | if | 270587986.12 ±8.03% | 2.67% slower |
| [crypto/ed25519.ts[0]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/crypto/ed25519.ts) | native crypto | 8.47 ±0.09% | 52.55% slower |
| [crypto/ed25519.ts[1]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/crypto/ed25519.ts) | wasm lib | 10.04 ±1.77% | 43.75% slower |
| [crypto/ed25519.ts[2]](../blob/362daf35f6782e19473186fa15c29ea5d0908069/benchmarks/crypto/ed25519.ts) | wasm lib batch | 17.85 ±24.38% | fastest ✅ |
</details>
