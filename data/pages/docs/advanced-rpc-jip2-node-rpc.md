...
last_modified: '2026-03-24T03:47:13.003Z'
---
...
## Notes [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#notes "Direct link to Notes")
...
## Protocol [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#protocol "Direct link to Protocol")
...
### Subscriptions [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscriptions "Direct link to Subscriptions")
...
## Common types [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#common-types "Direct link to Common types")
...
## Error codes [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#error-codes "Direct link to Error codes")
...
## Chain subscriptions [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#chain-subscriptions "Direct link to Chain subscriptions")
...
## Methods [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#methods "Direct link to Methods")

### `parameters()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters "Direct link to parameters")

Returns the chain parameters.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result "Direct link to Result")
...
- `"deposit_per_item"`: BI\\mathsf{B}\_IBI​, the additional minimum balance required per item of
elective service state.
- `"deposit_per_byte"`: BL\\mathsf{B}\_LBL​, the additional minimum balance required per octet of
elective service state
...
- `"min_turnaround_period"`: D\\mathsf{D}D, the period in timeslots after which an unreferenced
preimage may be expunged.
- `"epoch_period"`: E\\mathsf{E}E, the length of an epoch in timeslots.
- `"max_accumulate_gas"`: GA\\mathsf{G}\_AGA​, the gas allocated to invoke a work-report’s Accumulation
logic.
- `"max_is_authorized_gas"`: GI\\mathsf{G}\_IGI​, the gas allocated to invoke a work-package’s
Is-Authorized logic.
...
- `"max_tickets_per_block"`: K\\mathsf{K}K, the maximum number of tickets which may be submitted in
a single extrinsic.
...
- `"rotation_period"`: R\\mathsf{R}R, the rotation period of validator-core assignments, in
timeslots.
- `"max_extrinsics"`: T\\mathsf{T}T, the maximum number of extrinsics in a work-package.
- `"availability_timeout"`: U\\mathsf{U}U, the period in timeslots after which reported but
...
- `"max_input"`: WB\\mathsf{W}\_BWB​, the maximum size of the concatenated variable-size blobs,
...
- `"max_report_elective_data"`: WR\\mathsf{W}\_RWR​, the maximum total size of all unbounded blobs in a
...
- `"epoch_tail_start"`: Y\\mathsf{Y}Y, the number of slots into an epoch at which ticket-submission
ends.
...
### `bestBlock()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#bestblock "Direct link to bestblock")

Returns the header hash and slot of the head of the "best" chain.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-1 "Direct link to Result")

Block Descriptor.

### `subscribeBestBlock()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribebestblock "Direct link to subscribebestblock")

Subscribe to updates of the head of the "best" chain, as returned by `bestBlock`.

#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result "Direct link to subscription-update-result")

Block Descriptor.

### `finalizedBlock()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#finalizedblock "Direct link to finalizedblock")

Returns the header hash and slot of the latest finalized block.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-2 "Direct link to Result")

Block Descriptor.

### `subscribeFinalizedBlock()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribefinalizedblock "Direct link to subscribefinalizedblock")

Subscribe to updates of the latest finalized block, as returned by `finalizedBlock`.

#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-1 "Direct link to subscription-update-result-1")

Block Descriptor.

### `parent(header_hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parentheader_hash "Direct link to parentheader_hash")

Returns the header hash and slot of the parent of the block with the given header hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-1 "Direct link to Parameters")

1. `header_hash`: Hash.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-3 "Direct link to Result")

Block Descriptor: The parent of the block with the given header hash.

### `stateRoot(header_hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#staterootheader_hash "Direct link to staterootheader_hash")

Returns the posterior state root of the block with the given header hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-2 "Direct link to Parameters")

1. `header_hash`: Hash.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-4 "Direct link to Result")

Hash: The state root.

### `beefyRoot(header_hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#beefyrootheader_hash "Direct link to beefyrootheader_hash")

Returns the BEEFY root of the block with the given header hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-3 "Direct link to Parameters")

1. `header_hash`: Hash.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-5 "Direct link to Result")

Hash: The BEEFY root.

### `statistics(header_hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#statisticsheader_hash "Direct link to statisticsheader_hash")

Returns the activity statistics stored in the posterior state of the block with the given header
hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-4 "Direct link to Parameters")

1. `header_hash`: Hash: The header hash indicating the block whose posterior state should be used
for the query.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-6 "Direct link to Result")

Blob: Activity statistics encoded as per the GP.

### `subscribeStatistics(finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribestatisticsfinalized "Direct link to subscribestatisticsfinalized")

Subscribe to updates of the activity statistics stored in chain state.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-5 "Direct link to Parameters")

1. `finalized`: Boolean: True to track the latest finalized block, False to track the head of the
"best" chain.

#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-2 "Direct link to subscription-update-result-2")

Chain Subscription Update. The `"value"` member is a Blob, containing activity statistics encoded
as per the GP.

### `serviceData(header_hash, id)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#servicedataheader_hash-id "Direct link to servicedataheader_hash-id")

Returns the storage data for the service with the given ID.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-6 "Direct link to Parameters")

1. `header_hash`: Hash: The header hash indicating the block whose posterior state should be used
for the query.
2. `id`: Number: The ID of the service.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-7 "Direct link to Result")

Null if there is no service with the given ID, or Blob, containing the service data encoded as per
the GP.

### `subscribeServiceData(id, finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribeservicedataid-finalized "Direct link to subscribeservicedataid-finalized")

Subscribe to updates of the storage data for the service with the given ID.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-7 "Direct link to Parameters")
...
#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-3 "Direct link to subscription-update-result-3")
...
### `serviceValue(header_hash, id, key)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#servicevalueheader_hash-id-key "Direct link to servicevalueheader_hash-id-key")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-8 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-8 "Direct link to Result")

Null if there is no value associated with the given service ID and key, otherwise a Blob containing
the value.

### `subscribeServiceValue(id, key, finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribeservicevalueid-key-finalized "Direct link to subscribeservicevalueid-key-finalized")

Subscribe to updates of the value associated with the given service ID and key.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-9 "Direct link to Parameters")
...
#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-4 "Direct link to subscription-update-result-4")
...
### `servicePreimage(header_hash, id, hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#servicepreimageheader_hash-id-hash "Direct link to servicepreimageheader_hash-id-hash")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-10 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-9 "Direct link to Result")

Null if the preimage has not been provided to the given service, otherwise a Blob containing the
preimage.

### `subscribeServicePreimage(id, hash, finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribeservicepreimageid-hash-finalized "Direct link to subscribeservicepreimageid-hash-finalized")

Subscribe to updates of the preimage associated with the given service ID and hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-11 "Direct link to Parameters")
...
#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-5 "Direct link to subscription-update-result-5")
...
### `serviceRequest(header_hash, id, hash, len)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#servicerequestheader_hash-id-hash-len "Direct link to servicerequestheader_hash-id-hash-len")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-12 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-10 "Direct link to Result")
...
### `subscribeServiceRequest(id, hash, len, finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribeservicerequestid-hash-len-finalized "Direct link to subscribeservicerequestid-hash-len-finalized")

Subscribe to updates of the preimage request associated with the given service ID and hash/length.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-13 "Direct link to Parameters")
...
#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-6 "Direct link to subscription-update-result-6")
...
### `workReport(hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#workreporthash "Direct link to workreporthash")

Returns the work-report with the given hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-14 "Direct link to Parameters")

1. `hash`: Hash: Hash of the work-report.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-11 "Direct link to Result")

Blob: The work-report with the given hash, encoded as per the GP.

### `submitWorkPackage(core, package, extrinsics)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#submitworkpackagecore-package-extrinsics "Direct link to submitworkpackagecore-package-extrinsics")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-15 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-12 "Direct link to Result")

Null.

### `submitWorkPackageBundle(core, bundle)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#submitworkpackagebundlecore-bundle "Direct link to submitworkpackagebundlecore-bundle")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-16 "Direct link to Parameters")

1. `core`: Number: The index of the core.
2. `bundle`: Blob: The work-bundle, encoded as per the GP.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-13 "Direct link to Result")

Null.

### `workPackageStatus(header_hash, hash, anchor)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#workpackagestatusheader_hash-hash-anchor "Direct link to workpackagestatusheader_hash-hash-anchor")

Returns the status of the given work-package following execution of the block with the given header
hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-17 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-14 "Direct link to Result")

An Object with one of the following structures:

- {"Reportable": {
"remaining\_blocks": Number
}}
...
### `subscribeWorkPackageStatus(hash, anchor, finalized)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribeworkpackagestatushash-anchor-finalized "Direct link to subscribeworkpackagestatushash-anchor-finalized")

Subscribe to status updates for the given work-package.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-18 "Direct link to Parameters")
...
#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-7 "Direct link to subscription-update-result-7")
...
### `submitPreimage(requester, preimage)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#submitpreimagerequester-preimage "Direct link to submitpreimagerequester-preimage")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-19 "Direct link to Parameters")

1. `requester`: Number: The ID of the service which has an outstanding request.
2. `preimage`: Blob: The preimage requested.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-15 "Direct link to Result")

Null.

### `listServices(header_hash)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#listservicesheader_hash "Direct link to listservicesheader_hash")
...
#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-20 "Direct link to Parameters")

1. `header_hash`: Hash: The header hash indicating the block whose posterior state should be used
for the query.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-16 "Direct link to Result")

Array of Numbers: The IDs of the services currently known to be on JAM.

### `fetchWorkPackageSegments(wp_hash, indices)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#fetchworkpackagesegmentswp_hash-indices "Direct link to fetchworkpackagesegmentswp_hash-indices")

Fetches a list of segments from the DA layer, exported by the work-package with the given hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-21 "Direct link to Parameters")
...
#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-17 "Direct link to Result")
...
### `fetchSegments(segment_root, indices)` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#fetchsegmentssegment_root-indices "Direct link to fetchsegmentssegment_root-indices")

Fetches a list of segments from the DA layer, exported by a work-package with the given segment
root hash.

#### Parameters [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#parameters-22 "Direct link to Parameters")

1. `segment_root`: Hash: Segment tree root hash of a work-package.
2. `indices`: Array of Numbers: Indices into the list of segments exported by the work-package.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-18 "Direct link to Result")

Array of Blobs: The requested segments. Each Blob should be 4104 bytes long and the length of the
Array should match the length of the `indices` Array passed in to the method.

### `syncState()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#syncstate "Direct link to syncstate")

Returns the sync state of the node.

#### Result [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#result-19 "Direct link to Result")
...
### `subscribeSyncStatus()` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscribesyncstatus "Direct link to subscribesyncstatus")

Subscribe to changes in sync status.

#### Subscription update `"result"` [​](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc\#subscription-update-result-8 "Direct link to subscription-update-result-8")

String: Either `"InProgress"` or `"Completed"`.

- [Notes](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#notes)
- [Protocol](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#protocol)
  - [Subscriptions](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscriptions)
- [Common types](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#common-types)
- [Error codes](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#error-codes)
- [Chain subscriptions](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#chain-subscriptions)
- [Methods](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#methods)
  - [`parameters()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#parameters)
  - [`bestBlock()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#bestblock)
  - [`subscribeBestBlock()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribebestblock)
  - [`finalizedBlock()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#finalizedblock)
  - [`subscribeFinalizedBlock()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribefinalizedblock)
  - [`parent(header_hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#parentheader_hash)
  - [`stateRoot(header_hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#staterootheader_hash)
  - [`beefyRoot(header_hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#beefyrootheader_hash)
  - [`statistics(header_hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#statisticsheader_hash)
  - [`subscribeStatistics(finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribestatisticsfinalized)
  - [`serviceData(header_hash, id)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#servicedataheader_hash-id)
  - [`subscribeServiceData(id, finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribeservicedataid-finalized)
  - [`serviceValue(header_hash, id, key)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#servicevalueheader_hash-id-key)
  - [`subscribeServiceValue(id, key, finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribeservicevalueid-key-finalized)
  - [`servicePreimage(header_hash, id, hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#servicepreimageheader_hash-id-hash)
  - [`subscribeServicePreimage(id, hash, finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribeservicepreimageid-hash-finalized)
  - [`serviceRequest(header_hash, id, hash, len)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#servicerequestheader_hash-id-hash-len)
  - [`subscribeServiceRequest(id, hash, len, finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribeservicerequestid-hash-len-finalized)
  - [`workReport(hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#workreporthash)
  - [`submitWorkPackage(core, package, extrinsics)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#submitworkpackagecore-package-extrinsics)
  - [`submitWorkPackageBundle(core, bundle)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#submitworkpackagebundlecore-bundle)
  - [`workPackageStatus(header_hash, hash, anchor)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#workpackagestatusheader_hash-hash-anchor)
  - [`subscribeWorkPackageStatus(hash, anchor, finalized)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribeworkpackagestatushash-anchor-finalized)
  - [`submitPreimage(requester, preimage)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#submitpreimagerequester-preimage)
  - [`listServices(header_hash)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#listservicesheader_hash)
  - [`fetchWorkPackageSegments(wp_hash, indices)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#fetchworkpackagesegmentswp_hash-indices)
  - [`fetchSegments(segment_root, indices)`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#fetchsegmentssegment_root-indices)
  - [`syncState()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#syncstate)
  - [`subscribeSyncStatus()`](https://docs.jamcha.in/advanced/rpc/jip2-node-rpc#subscribesyncstatus)
