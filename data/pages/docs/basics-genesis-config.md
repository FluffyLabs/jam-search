...
last_modified: '2026-03-24T03:46:57.566Z'
---
...
## Authorities [​](https://docs.jamcha.in/basics/genesis-config\#authorities "Direct link to Authorities")

A list of Validator Key Tuples, called K\\mathbb{K}K in the Graypaper. This defines the validators that are permissioned to seal blocks for the current epoch. The accounts are the [Dev Accounts](https://docs.jamcha.in/basics/dev-accounts).

## Genesis Block Header [​](https://docs.jamcha.in/basics/genesis-config\#genesis-block-header "Direct link to Genesis Block Header")
...
### Chosen Values Rationale [​](https://docs.jamcha.in/basics/genesis-config\#chosen-values-rationale "Direct link to Chosen Values Rationale")
...
- `epoch_mark`: The first block in an epoch should contain the validators for the next epoch.
  ...
  - `validators`: Defined as the dev authorities [accounts](https://docs.jamcha.in/basics/dev-accounts).
...
## All Specs [​](https://docs.jamcha.in/basics/genesis-config\#all-specs "Direct link to All Specs")
...
- [Tiny](https://docs.jamcha.in/basics/chain-spec/tiny)`0xe864d485113737c28c2fef3b2aed39cb2f289a369b15c54e9c44720bcfdc0ca0`
- [Full](https://docs.jamcha.in/basics/chain-spec/full)`0x57f075e6bb0b8778b59261fa7ec32626464e4d2f444fca4312dfbf94f3584032`

- [Authorities](https://docs.jamcha.in/basics/genesis-config#authorities)
- [Genesis Block Header](https://docs.jamcha.in/basics/genesis-config#genesis-block-header)
  - [Chosen Values Rationale](https://docs.jamcha.in/basics/genesis-config#chosen-values-rationale)
- [All Specs](https://docs.jamcha.in/basics/genesis-config#all-specs)
