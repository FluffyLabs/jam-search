---
type: page
url: 'https://docs.jamcha.in/old/basics/genesis-config'
title: Genesis Config (Old) | JAM Docs
site: docs.jamcha.in
created_at: '2025-09-02T22:04:06.518Z'
last_modified: '2025-09-02T22:04:06.518Z'
---
...
This page does not take [JIP-5](https://github.com/polkadot-fellows/JIPs/pull/2) into account. The new version is available [here](https://docs.jamcha.in/basics/genesis-config).

## Authorities [​](https://docs.jamcha.in/old/basics/genesis-config\#authorities "Direct link to Authorities")

A list of Validator Key Tuples, called K\\mathbb{K}K in the Graypaper. This defines the validators that are permissioned to seal blocks for the current epoch. The accounts are the [Dev Accounts](https://docs.jamcha.in/old/basics/dev-accounts).

## Genesis Block Header [​](https://docs.jamcha.in/old/basics/genesis-config\#genesis-block-header "Direct link to Genesis Block Header")

The genesis block header (H0H\_0H0​) is the initial header in the chain, upon which
...
### Chosen Values Rationale [​](https://docs.jamcha.in/old/basics/genesis-config\#chosen-values-rationale "Direct link to Chosen Values Rationale")
...
- `epoch_mark`: The first block in an epoch should contain the validators for the next epoch.
  ...
  - `validators`: Defined as the dev authorities [accounts](https://docs.jamcha.in/old/basics/dev-accounts).
...
represents the genesis state (σ0σ\_0σ0​), should match with some of the values
...
It is important to note that using this header as H0H\_0H0​ will inevitably
lead to small inconsistencies within the state it references, σ0\\sigma\_0σ0​. These
...
State Transition Function (STF). Specifically, σ0⋅η0\\sigma\_0 \\cdot \\eta\_0σ0​⋅η0​ is technically
...
## All Specs [​](https://docs.jamcha.in/old/basics/genesis-config\#all-specs "Direct link to All Specs")
...
- [Tiny](https://docs.jamcha.in/basics/chain-spec/tiny) `0x476243ad7cc4fc49cb6cb362c6568e931731d8650d917007a6037cceedd62244`
- [Small](https://docs.jamcha.in/basics/chain-spec/small) `0x67cfc50bfec9d5408ca5c72bf90cd7f109cd3a001787900f68a8e666c6665bd4`
- [Medium](https://docs.jamcha.in/basics/chain-spec/medium) `0x3756763d49854b97de440b301f1c69ef0f6981c64c4ffc764c0ad5a8870f1901`
- [Large](https://docs.jamcha.in/basics/chain-spec/large) `0xb3d06530c201be34522f4df0df3e572f37f046b8f26e74dc24307c3b36d05e22`
- [xLarge](https://docs.jamcha.in/basics/chain-spec/xlarge) `0x1031339ffb6e132953a3d97ee0e38728bebadfef4cc7453642226cb0ccb53b27`
- [2xLarge](https://docs.jamcha.in/basics/chain-spec/2xlarge) `0x8e5a7a7e28a973b45927da8539fe222faa45dcb0d1d6133afe0dbc398cfdcbe5`
- [3xLarge](https://docs.jamcha.in/basics/chain-spec/3xlarge) `0xe53cfeb7a3f892be40dbe6098efa5f5ba6b28e9a9edde447a56664540c02f901`
- [Full](https://docs.jamcha.in/basics/chain-spec/full) `0xef6195f355ae03123e065990d34470be9a112df37029d340e1a8428e5d541a55`

- [Authorities](https://docs.jamcha.in/old/basics/genesis-config#authorities)
- [Genesis Block Header](https://docs.jamcha.in/old/basics/genesis-config#genesis-block-header)
  - [Chosen Values Rationale](https://docs.jamcha.in/old/basics/genesis-config#chosen-values-rationale)
- [All Specs](https://docs.jamcha.in/old/basics/genesis-config#all-specs)
