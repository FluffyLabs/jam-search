...
site: docs.jamcha.in
created_at: '2025-11-06T23:00:15.931Z'
last_modified: '2026-03-24T03:46:31.080Z'
---
...
### JAMNP + OpenTelemetry [​](https://docs.jamcha.in/knowledge/advanced/telemetry\#jamnp--opentelemetry "Direct link to JAMNP + OpenTelemetry")

The [JAMNP spec](https://docs.jamcha.in/knowledge/advanced/simple-networking/spec) is used as a primary starting point to develop a telemetry system:

01. UP 0: Block Announcement
02. CE 128: Block Request
03. CE 129: State Request (for warp sync)
04. CE 131/132: Safrole Ticket Distribution
05. CE 133: Work-Package Submission
06. CE 134: Work-Package Sharing
07. CE 135: Work-Report Distribution
08. CE 136: Work-Report Request
09. CE 137: Shard Distribution
...
## Contributions welcome [​](https://docs.jamcha.in/knowledge/advanced/telemetry\#contributions-welcome "Direct link to Contributions welcome")
...
- [JAMNP + OpenTelemetry](https://docs.jamcha.in/knowledge/advanced/telemetry#jamnp--opentelemetry)
- [Contributions welcome](https://docs.jamcha.in/knowledge/advanced/telemetry#contributions-welcome)
