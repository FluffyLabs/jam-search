---
type: page
url: 'https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates'
title: OpenSSL Certificate Generation | JAM Docs
site: docs.jamcha.in
created_at: '2025-05-26T09:22:35.065Z'
last_modified: '2025-09-02T22:03:30.854Z'
---
This guide demonstrates how to generate Ed25519 keys and certificates for the [Alice](https://docs.jamcha.in/basics/dev-accounts#alice) dev account using the OpenSSL CLI. These certificates can be used for the [Simple Networking Protocol](https://docs.jamcha.in/knowledge/advanced/simple-networking/spec#encryption-and-handshake).

## Secret Key Generation [​](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates\#secret-key-generation "Direct link to Secret Key Generation")
...
## Certificate Generation [​](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates\#certificate-generation "Direct link to Certificate Generation")
...
Where `$DNS_ALT_NAME` should match the [SNP Specification](https://docs.jamcha.in/knowledge/advanced/simple-networking/spec#encryption-and-handshake). (The DNS alt name was reported to be wrong, please do not rely on it).
...
## Alice [​](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates\#alice "Direct link to Alice")
...
- [Secret Key Generation](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates#secret-key-generation)
- [Certificate Generation](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates#certificate-generation)
- [Alice](https://docs.jamcha.in/knowledge/advanced/simple-networking/Certificates#alice)
