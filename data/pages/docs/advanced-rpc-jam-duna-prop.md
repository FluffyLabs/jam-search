...
last_modified: '2026-03-24T03:47:15.667Z'
---
warning
...
#### Request JSON Response [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#request-json-response "Direct link to Request JSON Response")
...
#### Request JAM Codec Response: [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#request-jam-codec-response "Direct link to Request JAM Codec Response:")
...
## Pagination [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#pagination "Direct link to Pagination")

Pagination details are TBD.

# Example curl calls

## jam\_getBlockByHash [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getblockbyhash "Direct link to jam_getBlockByHash")
...
## jam\_getWorkPackageByHash [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getworkpackagebyhash "Direct link to jam_getWorkPackageByHash")
...
## jam\_getWorkReportByHash (similar to [CE 136: Work-report request](https://github.com/zdave-parity/jam-np/blob/main/simple.md)) [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getworkreportbyhash-similar-to-ce-136-work-report-request "Direct link to jam_getworkreportbyhash-similar-to-ce-136-work-report-request")
...
## jam\_getService [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getservice "Direct link to jam_getService")
...
## jam\_getServiceCode [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getservicecode "Direct link to jam_getServiceCode")
...
## jam\_getServicePreimage [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getservicepreimage "Direct link to jam_getServicePreimage")
...
## jam\_getServiceLookup [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getservicelookup "Direct link to jam_getServiceLookup")
...
## jam\_getServiceStorage [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getservicestorage "Direct link to jam_getServiceStorage")
...
## jam\_getState (similar to [CE 129](https://github.com/zdave-parity/jam-np/blob/main/simple.md\#ce-129-state-request)) [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_getstate-similar-to-ce-129 "Direct link to jam_getstate-similar-to-ce-129")
...
## jam\_submitWorkPackage (similar to JAMNP - CE 133) [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#jam_submitworkpackage-similar-to-jamnp---ce-133 "Direct link to jam_submitWorkPackage (similar to JAMNP - CE 133)")
...
## Other RPC methods [​](https://docs.jamcha.in/advanced/rpc/jam-duna-prop\#other-rpc-methods "Direct link to Other RPC methods")
...
- [Pagination](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#pagination)
- [jam\_getBlockByHash](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getblockbyhash)
- [jam\_getWorkPackageByHash](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getworkpackagebyhash)
- [jam\_getWorkReportByHash (similar to CE 136: Work-report request)](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getworkreportbyhash-similar-to-ce-136-work-report-request)
- [jam\_getService](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getservice)
- [jam\_getServiceCode](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getservicecode)
- [jam\_getServicePreimage](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getservicepreimage)
- [jam\_getServiceLookup](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getservicelookup)
- [jam\_getServiceStorage](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getservicestorage)
- [jam\_getState (similar to CE 129)](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_getstate-similar-to-ce-129)
- [jam\_submitWorkPackage (similar to JAMNP - CE 133)](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#jam_submitworkpackage-similar-to-jamnp---ce-133)
- [Other RPC methods](https://docs.jamcha.in/advanced/rpc/jam-duna-prop#other-rpc-methods)
