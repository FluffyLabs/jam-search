...
last_modified: '2026-03-24T03:46:48.051Z'
---
...
## Dos and Don'ts [​](https://docs.jamcha.in/dao/code_of_conduct\#dos-and-donts "Direct link to Dos and Don'ts")

This section provides a brief overview of the expectation and guidelines for DAO members.

### Dos: [​](https://docs.jamcha.in/dao/code_of_conduct\#dos "Direct link to Dos:")
...
### Don'ts: [​](https://docs.jamcha.in/dao/code_of_conduct\#donts "Direct link to Don'ts:")
...
## Private+Public Telegram/Discord/Matrix Chat Rules [​](https://docs.jamcha.in/dao/code_of_conduct\#privatepublic-telegramdiscordmatrix-chat-rules "Direct link to Private+Public Telegram/Discord/Matrix Chat Rules")
...
## Disclaimer on the Mutability of the Rules [​](https://docs.jamcha.in/dao/code_of_conduct\#disclaimer-on-the-mutability-of-the-rules "Direct link to Disclaimer on the Mutability of the Rules")
...
- [Dos and Don'ts](https://docs.jamcha.in/dao/code_of_conduct#dos-and-donts)
  - [Dos:](https://docs.jamcha.in/dao/code_of_conduct#dos)
  - [Don'ts:](https://docs.jamcha.in/dao/code_of_conduct#donts)
- [Private+Public Telegram/Discord/Matrix Chat Rules](https://docs.jamcha.in/dao/code_of_conduct#privatepublic-telegramdiscordmatrix-chat-rules)
- [Disclaimer on the Mutability of the Rules](https://docs.jamcha.in/dao/code_of_conduct#disclaimer-on-the-mutability-of-the-rules)
