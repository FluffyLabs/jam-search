...
last_modified: '2026-03-24T03:46:45.383Z'
---
...
### Voting on Discord [​](https://docs.jamcha.in/dao/opengov\#voting-on-discord "Direct link to Voting on Discord")
...
### Voting Philosophy [​](https://docs.jamcha.in/dao/opengov\#voting-philosophy "Direct link to Voting Philosophy")
...
### Voting Mechanics [​](https://docs.jamcha.in/dao/opengov\#voting-mechanics "Direct link to Voting Mechanics")
...
#### Voting Policy [​](https://docs.jamcha.in/dao/opengov\#voting-policy "Direct link to Voting Policy")
...
- MIN\_PARTICIPATION: 45% -- the number of members required to vote before an AYE or NAY vote can be cast.
- Voting Threshold: 51% -- The percentage of AYE (or NAY) votes relative to the total number of votes cast to vote AYE (or NAY).

If neither the MIN\_PARTICIPATION nor Voting Threshold is met, the resulting vote is _abstain_.

Members _may_ be removed due to lack of voting behavior in order to meet MIN\_PARTICIPATION objectives.

### Conflict of Interest [​](https://docs.jamcha.in/dao/opengov\#conflict-of-interest "Direct link to Conflict of Interest")

Any member with a direct or indirect connection to a proposal must abstain from voting on the related referendum.

### Delegations [​](https://docs.jamcha.in/dao/opengov\#delegations "Direct link to Delegations")

Members may delegate to the DAO freely or choose not to delegate anything at all.

### Reimbursements / Disbursements [​](https://docs.jamcha.in/dao/opengov\#reimbursements--disbursements "Direct link to Reimbursements / Disbursements")
...
- [Voting on Discord](https://docs.jamcha.in/dao/opengov#voting-on-discord)
- [Voting Philosophy](https://docs.jamcha.in/dao/opengov#voting-philosophy)
- [Voting Mechanics](https://docs.jamcha.in/dao/opengov#voting-mechanics)
- [Conflict of Interest](https://docs.jamcha.in/dao/opengov#conflict-of-interest)
- [Delegations](https://docs.jamcha.in/dao/opengov#delegations)
- [Reimbursements / Disbursements](https://docs.jamcha.in/dao/opengov#reimbursements--disbursements)
