...
last_modified: '2026-03-24T03:47:00.102Z'
---
...
## Seeds [​](https://docs.jamcha.in/basics/dev-accounts\#seeds "Direct link to Seeds")
...
## Bandersnatch Nomenclature [​](https://docs.jamcha.in/basics/dev-accounts\#bandersnatch-nomenclature "Direct link to Bandersnatch Nomenclature")

Only the `bandersnatch_secret_seed` is shown since it is sufficient to calculate the `bandersnatch_public` key.
Internally, many implementations may first generate a _secret_ key (aka _Scalar_) and then derive the public key from it.
But this is an implementation detail and therefore not listed here.

## Alice [​](https://docs.jamcha.in/basics/dev-accounts\#alice "Direct link to Alice")
...
## Bob [​](https://docs.jamcha.in/basics/dev-accounts\#bob "Direct link to Bob")
...
## Carol [​](https://docs.jamcha.in/basics/dev-accounts\#carol "Direct link to Carol")
...
## David [​](https://docs.jamcha.in/basics/dev-accounts\#david "Direct link to David")
...
## Eve [​](https://docs.jamcha.in/basics/dev-accounts\#eve "Direct link to Eve")
...
## Fergie [​](https://docs.jamcha.in/basics/dev-accounts\#fergie "Direct link to Fergie")
...
- [Seeds](https://docs.jamcha.in/basics/dev-accounts#seeds)
- [Bandersnatch Nomenclature](https://docs.jamcha.in/basics/dev-accounts#bandersnatch-nomenclature)
- [Alice](https://docs.jamcha.in/basics/dev-accounts#alice)
- [Bob](https://docs.jamcha.in/basics/dev-accounts#bob)
- [Carol](https://docs.jamcha.in/basics/dev-accounts#carol)
- [David](https://docs.jamcha.in/basics/dev-accounts#david)
- [Eve](https://docs.jamcha.in/basics/dev-accounts#eve)
- [Fergie](https://docs.jamcha.in/basics/dev-accounts#fergie)
