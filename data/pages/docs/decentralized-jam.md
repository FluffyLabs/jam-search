...
created_at: '2025-07-23T13:14:00.119Z'
last_modified: '2025-11-22T03:23:54.203Z'
---
[Read the Rules](https://jam.web3.foundation/rules) [Milestone Delivery](https://github.com/w3f/jam-milestone-delivery)

# 10 Million DOT for a  DecentralizedJAM
...
JAM is theJoin-Accumulate Machine, a new protocol designed to succeed the Polkadot relay chain. It provides significantly enhanced smart contract functionality. [Learn more →](https://graypaper.com/)
...
Please carefully review the [full rules for submissions](https://jam.web3.foundation/rules).
...
[Get in Touch->](https://forms.gle/1Mgs7PX3yLM5x1d18) [Read the Rules](https://jam.web3.foundation/rules) [Milestone Delivery](https://github.com/w3f/jam-milestone-delivery)
