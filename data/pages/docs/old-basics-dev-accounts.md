---
type: page
url: 'https://docs.jamcha.in/old/basics/dev-accounts'
title: Dev Accounts (Old) | JAM Docs
site: docs.jamcha.in
created_at: '2025-09-02T22:03:59.586Z'
last_modified: '2025-09-02T22:03:59.586Z'
---
These well known accounts can be used for testing and are known by all JAM node implementations.

warning

This page does not take [JIP-5](https://github.com/polkadot-fellows/JIPs/pull/2) into account. The new version is available [here](https://docs.jamcha.in/basics/dev-accounts).

## Seeds [​](https://docs.jamcha.in/old/basics/dev-accounts\#seeds "Direct link to Seeds")

The 256 bit seeds for the dev accounts are generated by encoding the index of the validator as unsigned 32-bit little endian integer and repeating that sequence of bits 8 times. You should _not hash_ these seeds - otherwise the created accounts will be different.
...
## Alice [​](https://docs.jamcha.in/old/basics/dev-accounts\#alice "Direct link to Alice")
...
## Bob [​](https://docs.jamcha.in/old/basics/dev-accounts\#bob "Direct link to Bob")
...
## Carol [​](https://docs.jamcha.in/old/basics/dev-accounts\#carol "Direct link to Carol")
...
## David [​](https://docs.jamcha.in/old/basics/dev-accounts\#david "Direct link to David")
...
## Eve [​](https://docs.jamcha.in/old/basics/dev-accounts\#eve "Direct link to Eve")
...
## Fergie [​](https://docs.jamcha.in/old/basics/dev-accounts\#fergie "Direct link to Fergie")
...
- [Seeds](https://docs.jamcha.in/old/basics/dev-accounts#seeds)
- [Alice](https://docs.jamcha.in/old/basics/dev-accounts#alice)
- [Bob](https://docs.jamcha.in/old/basics/dev-accounts#bob)
- [Carol](https://docs.jamcha.in/old/basics/dev-accounts#carol)
- [David](https://docs.jamcha.in/old/basics/dev-accounts#david)
- [Eve](https://docs.jamcha.in/old/basics/dev-accounts#eve)
- [Fergie](https://docs.jamcha.in/old/basics/dev-accounts#fergie)
