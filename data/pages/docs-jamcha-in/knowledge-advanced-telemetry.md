...
site: docs.jamcha.in
created_at: '2026-06-19T04:29:32.500Z'
last_modified: '2026-06-19T04:29:32.500Z'
---
...
Our primary focus is monitoring node-to-node communications of a network of any size (from tiny V=6 to toaster V=1023) composed of multiple client implementations. Internal node tracing (mapping to Jaeger) may be pursued by individual teams but does NOT need to be coordinated and is outside of the scope.

At this point this is just a proto-spec for JAM implementation teams to come to some consensus on what event types should be instrumented and roughly how. We can then develop working prototypes and discuss how to deal with errors and precise formats with a few teams.

### JAMNP + OpenTelemetry[​](#jamnp--opentelemetry "Direct link to JAMNP + OpenTelemetry")
...
## Contributions welcome[​](#contributions-welcome "Direct link to Contributions welcome")
...
For your contribution, your don't have ANYTHING depend on some internal type to your JAM implementation so everyone can literally include this code.
...
*   [JAMNP + OpenTelemetry](#jamnp--opentelemetry)
