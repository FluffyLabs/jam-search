...
language: markdown
---
`docs/src/SUMMARY.md` (lines 1–12)
...
- [SDK API](./sdk-api.md)
  - [Common](./sdk-api/common.md)
  - [Refine](./sdk-api/refine.md)
  - [Accumulate](./sdk-api/accumulate.md)
  - [Authorize](./sdk-api/authorize.md)
  - [Utilities](./sdk-api/utilities.md)
  - [Host Calls (ecalli)](./sdk-api/ecalli.md)
- [Testing](./testing.md)
```
