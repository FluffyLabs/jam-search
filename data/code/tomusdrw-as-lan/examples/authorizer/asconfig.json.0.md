...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/authorizer/asconfig.json#L1-L30
title: examples/authorizer/asconfig.json
...
language: json
---
`examples/authorizer/asconfig.json` (lines 1–30)
