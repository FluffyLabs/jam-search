...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/ecalli-test/asconfig.json#L1-L30
title: examples/ecalli-test/asconfig.json
...
language: json
---
`examples/ecalli-test/asconfig.json` (lines 1–30)
