...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/ecalli-test/assembly/tsconfig.json#L1-L10
title: examples/ecalli-test/assembly/tsconfig.json
...
language: json
---
`examples/ecalli-test/assembly/tsconfig.json` (lines 1–10)
