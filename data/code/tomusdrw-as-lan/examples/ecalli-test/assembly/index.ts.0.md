...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/ecalli-test/assembly/index.ts#L1-L10
title: examples/ecalli-test/assembly/index.ts
...
language: typescript
---
`examples/ecalli-test/assembly/index.ts` (lines 1–10)
