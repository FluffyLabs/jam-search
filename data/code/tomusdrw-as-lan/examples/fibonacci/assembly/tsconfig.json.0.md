...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/fibonacci/assembly/tsconfig.json#L1-L10
title: examples/fibonacci/assembly/tsconfig.json
...
language: json
---
`examples/fibonacci/assembly/tsconfig.json` (lines 1–10)
