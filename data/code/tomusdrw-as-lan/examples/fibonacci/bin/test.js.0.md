...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/fibonacci/bin/test.js#L1-L7
title: examples/fibonacci/bin/test.js
...
language: javascript
---
`examples/fibonacci/bin/test.js` (lines 1–7)
