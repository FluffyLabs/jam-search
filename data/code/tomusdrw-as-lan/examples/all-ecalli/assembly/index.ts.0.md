...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/all-ecalli/assembly/index.ts#L1-L10
title: examples/all-ecalli/assembly/index.ts
...
language: typescript
---
`examples/all-ecalli/assembly/index.ts` (lines 1–10)
