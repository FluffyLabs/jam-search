...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/library/assembly/tsconfig.json#L1-L10
title: examples/library/assembly/tsconfig.json
...
language: json
---
`examples/library/assembly/tsconfig.json` (lines 1–10)
