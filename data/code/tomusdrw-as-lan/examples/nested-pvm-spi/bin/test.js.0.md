...
content_kind: code
url: >-
  https://github.com/tomusdrw/as-lan/blob/main/examples/nested-pvm-spi/bin/test.js#L1-L7
title: examples/nested-pvm-spi/bin/test.js
...
language: javascript
---
`examples/nested-pvm-spi/bin/test.js` (lines 1–7)
