...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/parent.ts#L1-L38
title: packages/jam/rpc/src/handlers/parent.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/parent.ts` (lines 1–38)
