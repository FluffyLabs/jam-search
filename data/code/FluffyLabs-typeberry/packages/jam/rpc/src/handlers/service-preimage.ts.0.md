...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/service-preimage.ts#L1-L30
title: packages/jam/rpc/src/handlers/service-preimage.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/service-preimage.ts` (lines 1–30)
