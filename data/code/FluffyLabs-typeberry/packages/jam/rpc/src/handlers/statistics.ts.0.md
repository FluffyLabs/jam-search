...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/statistics.ts#L1-L20
title: packages/jam/rpc/src/handlers/statistics.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/statistics.ts` (lines 1–20)
