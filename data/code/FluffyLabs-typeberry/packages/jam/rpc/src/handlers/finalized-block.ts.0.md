...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/finalized-block.ts#L1-L9
title: packages/jam/rpc/src/handlers/finalized-block.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/finalized-block.ts` (lines 1–9)
