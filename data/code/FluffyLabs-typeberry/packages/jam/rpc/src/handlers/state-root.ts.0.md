...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/state-root.ts#L1-L19
title: packages/jam/rpc/src/handlers/state-root.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/state-root.ts` (lines 1–19)
