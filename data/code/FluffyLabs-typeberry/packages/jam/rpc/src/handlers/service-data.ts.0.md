...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/rpc/src/handlers/service-data.ts#L1-L26
title: packages/jam/rpc/src/handlers/service-data.ts
...
language: typescript
---
`packages/jam/rpc/src/handlers/service-data.ts` (lines 1–26)
