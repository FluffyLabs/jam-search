...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/config-node/node-config.test.ts#L1-L112
...
chunk_index: 0
chunk_total: 3
content_sha: 9d7369acf548aea49caed6a004373c6f523f72ad1afca6d8b9102b31c76d3d43
language: typescript
---
`packages/jam/config-node/node-config.test.ts` (lines 1–112)
