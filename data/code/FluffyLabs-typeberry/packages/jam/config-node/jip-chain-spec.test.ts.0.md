...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/config-node/jip-chain-spec.test.ts#L1-L101
...
chunk_index: 0
chunk_total: 2
content_sha: 0cfcff0d2a352b77b8c44dff0a88414f34353469d96be8e643098bbf0752c40a
language: typescript
---
`packages/jam/config-node/jip-chain-spec.test.ts` (lines 1–101)
...
describe("Importing JIP Chain Spec", () => {
  ...
  it("should not throw an error when the bootnodes are missing", () => {
    ...
    assert.doesNotThrow(() => parseFromJson(invalidSpec, JipChainSpec.fromJson));
  });
