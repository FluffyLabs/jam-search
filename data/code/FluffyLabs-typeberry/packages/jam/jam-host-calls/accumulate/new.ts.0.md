...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/jam/jam-host-calls/accumulate/new.ts#L1-L92
title: packages/jam/jam-host-calls/accumulate/new.ts
site: github.com/FluffyLabs/typeberry
created_at: '2026-08-14T15:27:42+02:00'
last_modified: '2026-08-14T15:27:42+02:00'
chunk_index: 0
chunk_total: 1
content_sha: 5113cf76317f5078b5143bd670f91e4a900b935615faf35266640ea57fed947e
language: typescript
---
`packages/jam/jam-host-calls/accumulate/new.ts` (lines 1–92)
...
export class New implements HostCallHandler {
  ...
  async execute(_gas: IGasCounter, regs: HostCallRegisters, memory: HostCallMemory): Promise<undefined | PvmExecution> {
    ...
    if (memoryReadResult.isError) {
      logger.trace`[${this.currentServiceId}] NEW(${codeHash}, ${codeLength}, ${gas}, ${allowance}, ${gratisStorage}, ${requestedServiceId}) <- PANIC`;
    ...
    logger.trace`[${this.currentServiceId}] NEW(${codeHash}, ${codeLength}, ${gas}, ${allowance}, ${gratisStorage}, ${requestedServiceId}) <- ${resultToString(assignedId)}`;
