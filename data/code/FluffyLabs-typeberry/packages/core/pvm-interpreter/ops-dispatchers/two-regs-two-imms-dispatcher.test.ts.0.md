...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/packages/core/pvm-interpreter/ops-dispatchers/two-regs-two-imms-dispatcher.test.ts#L1-L105
title: >-
...
language: typescript
---
`packages/core/pvm-interpreter/ops-dispatchers/two-regs-two-imms-dispatcher.test.ts` (lines 1–105)
