...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/bin/rpc/src/handlers/parameters.ts#L1-L60
title: bin/rpc/src/handlers/parameters.ts
...
language: typescript
---
`bin/rpc/src/handlers/parameters.ts` (lines 1–60)
