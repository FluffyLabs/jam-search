...
content_kind: code
url: >-
  https://github.com/FluffyLabs/typeberry/blob/main/bin/rpc/src/handlers/subscribe-best-block.ts#L1-L9
title: bin/rpc/src/handlers/subscribe-best-block.ts
...
language: typescript
---
`bin/rpc/src/handlers/subscribe-best-block.ts` (lines 1–9)
