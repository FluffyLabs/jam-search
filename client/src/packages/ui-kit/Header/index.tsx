      ...
      <div className="flex items-center gap-5 sm:w-full">
        <div className="flex items-center pl-4">
          <img
            src={Logo}
            alt="FluffyLabs logo"
            className="h-[40px] max-w-fit"
          />
          <img
            src={Brand}
            alt="FluffyLabs brand"
            className="hidden md:inline ml-4 h-[28px]"
          />
        </div>
        <Separator
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-[#242424] mt-1 p-4 border-none text-white min-w-[315px]">
            <DropdownMenuItem
              onSelect={() =>
                window.open(
                  "https://github.com/FluffyLabs/pvm-debugger/issues/new",
                  "_blank"
                )
              }
            ...
            <DropdownMenuItem
              onSelect={() =>
                window.open(
                  "https://github.com/FluffyLabs/pvm-debugger/fork",
                  "_blank"
                )
              }
              className="pl-3 py-3 flex items-start justify-between hover:bg-[#2D2D2D] focus:bg-[#2D2D2D] focus:text-whit"
